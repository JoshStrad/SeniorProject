...
import './nba.css';  // Import the external CSS file

// NBA teams data grouped by conference and division
const nbaTeams = {
  Eastern: {
    Atlantic: [ { name: 'Boston Celtics', path: '/nba/boston-celtics' , logo: 'https://www.pngmart.com/files/23/Celtics-Logo-PNG-Isolated-HD.png'},
    ...
    Central: [  { name: 'Clevaland Cavliers', path: '/nba/clevaland-cavaliers' , logo: 'https://logos-world.net/wp-content/uploads/2020/05/Cleveland-Cavaliers-Logo-2017-present.png' },
                ...
                { name: 'Detriot Pistons', path: '/nba/detroit-pistons' , logo: 'https://th.bing.com/th/id/R.dd68dd2cca6f7857b0ce4715fc9a78ff?rik=sv2chnVKcknDqw&pid=ImgRaw&r=0'},
                ...
                { name: 'Milawkee Bucks', path: '/nba/milawkee-bucks', logo: 'https://logodownload.org/wp-content/uploads/2020/07/milwaukee-bucks-logo-0.png' }
            ],
    Southeast: [{ name: 'Atlanta Hawks', path: '/nba/atlanta-hawks', logo: 'https://cdn.freebiesupply.com/images/large/2x/atlanta-hawks-logo-transparent.png' },
  ...
  Western: {
    Northwest: [{ name: 'Denver Nuggets', path: '/nba/denver-nuggets', logo: 'https://th.bing.com/th/id/R.bfa94f12ae0725355036662a8417a6bc?rik=kyga%2f0aHuUTovg&pid=ImgRaw&r=0'  },
                ...
                { name: 'Portland Trailblazers', path: '/nba/portland-trailblazers', logo: 'https://th.bing.com/th/id/R.e096d676a88cb410627ea06ec21d2885?rik=C3igBMCH%2b5Z7oQ&riu=http%3a%2f%2flogos-download.com%2fwp-content%2fuploads%2f2016%2f04%2fPortland_Trail_Blazers_logo_logotype.png&ehk=4BKaYJPpmCOnoHB%2fYwwdjTP31PF%2bzPZndrZQFjkHn9A%3d&risl=&pid=ImgRaw&r=0' },
                { name: 'Utah Jazz', path: '/nba/utah-jazz', logo: 'https://th.bing.com/th/id/R.659c4db43ea9c54ad904382c172241dc?rik=lGeC6FNxo829EA&riu=http%3a%2f%2flogos-download.com%2fwp-content%2fuploads%2f2016%2f04%2fUtah_Jazz_logo_alternate_note.png&ehk=cU2CIdTVQDwI1WTSXQd1RmgYu3Te%2fTG%2bvNKtSEElJgQ%3d&risl=&pid=ImgRaw&r=0' }
    ],
    Pacific: [  { name: 'Golden State Warriors', path: '/nba/gsw', logo: 'https://tse1.mm.bing.net/th/id/OIP.zOjtjNNbnzy0Q2IEsmRPiwHaI8?rs=1&pid=ImgDetMain' },
                ...
                { name: 'Sacremento Kings', path: '/nba/sacremento-kings' , logo: 'https://cdn.freebiesupply.com/images/large/2x/sacramento-kings-logo-transparent.png'}
        ],
    Southwest: [{ name: 'Dallas-Mavericks', path: '/nba/boston-celtics' , logo: 'https://logodownload.org/wp-content/uploads/2021/07/dallas-mavericks-logo-1.png'},
