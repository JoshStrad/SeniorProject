  ...
  return (
    <>
      ...
      <main className="profile-container bills-aura">
        ...
        <p>College: Wyoming</p>
        <p>Drafted: 7th overall in the 2018 NFL Draft by the Buffalo Bills</p>
        ...
        <div className="bio">
          <h2>Bio</h2>
          <p>
            Josh Allen is a dual-threat quarterback known for his rocket arm, physicality, and leadership. 
            Since joining the Buffalo Bills, he has transformed into one of the league’s most dynamic players, 
            capable of making highlight throws and rushing touchdowns in clutch moments.
          </p>
        </div>

        {/* Player Stats */}
        <div className="stats">
          <h2>Josh Allen Stats</h2>
