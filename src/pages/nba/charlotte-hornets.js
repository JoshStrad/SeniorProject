...
const CharlotteHornets = () => {
  const roster = [
    ...
    { name: 'Spencer Dinwiddie', position: 'PG', number: 26, profileLink: '/nba/hornets/spencer-dinwiddie' },
    ...
    { name: 'DaQuan Jeffries', position: 'SG', number: 3, profileLink: '/nba/hornets/daquan-jeffries' },
    ...
    { name: 'Drew Peterson', position: 'F', number: null, profileLink: '/nba/hornets/drew-peterson' },
    ...
    { name: 'Nick Smith Jr.', position: 'G', number: 8, profileLink: '/nba/hornets/nick-smith-jr' },
